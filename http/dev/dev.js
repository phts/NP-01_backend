...
document.getElementById('button-livelog-enable').onclick = function () {
  socket.emit('callMethod', {endpoint: 'system_controller/system', method: 'enableLiveLog', data: 'true'})
}
document.getElementById('button-livelog-disable').onclick = function () {
  socket.emit('callMethod', {endpoint: 'system_controller/system', method: 'enableLiveLog', data: 'false'})
}
...
document.getElementById('enable-display-a').onclick = function () {
  socket.emit('callMethod', {
    endpoint: 'system_controller/motivocontrol',
    method: 'displaySelection',
    data: {action: 'enable-display-a'},
  })
}
document.getElementById('enable-display-b').onclick = function () {
  socket.emit('callMethod', {
    endpoint: 'system_controller/motivocontrol',
    method: 'displaySelection',
    data: {action: 'enable-display-b'},
  })
}
