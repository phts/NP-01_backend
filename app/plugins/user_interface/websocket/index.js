...
function InterfaceWebUI(context) {
  ...
  self.libSocketIO.on('connection', function (connWebSocket) {
    ...
    connWebSocket.on('restoreConfig', function (data) {
      ...
      var response = self.commandRouter
        .restorePluginsConf()
    ...
    connWebSocket.on('receiveMultiroomDeviceUpdate', function (data) {
      var returnedData = self.commandRouter.executeOnPlugin(
        'system_controller',
        'volumiodiscovery',
        'receiveMultiroomDeviceUpdate',
        data
      )
    })
    ...
    connWebSocket.on('getExtendedOutputDevices', function () {
      ...
      var audiolist = self.commandRouter.executeOnPlugin(
        'audio_interface',
        'alsa_controller',
        'getExtendedOutputDevices',
        ''
      )
