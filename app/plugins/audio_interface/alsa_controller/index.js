...
ControllerAlsa.prototype.onVolumioStart = function () {
  ...
  if (process.env.MODULAR_ALSA_PIPELINE === 'true') {
    ...
    if (outputdevicecard) {
      ...
      self.logger.warn(
        'Unable to locate the audio output device ' + outputdevicename + '. Please configure a valid output device.'
      )
    }
...
ControllerAlsa.prototype.getUIConfig = function () {
  ...
  self.commandRouter
    ...
    .then(function (uiconf) {
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[3].content[0].label',
        self.commandRouter.getI18nString('PLAYBACK_OPTIONS.MIXER_TYPE')
      )
      ...
      if (
        (volumioDeviceName === 'primo' && outdevicename === 'Analog RCA Output') ||
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[3].content[1].label',
        self.commandRouter.getI18nString('PLAYBACK_OPTIONS.MIXER_CONTROL_NAME')
      )
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[2].content[0].value.label',
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[2].content[1].value.label',
        self.getLabelForSelect(self.configManager.getValue(uiconf, 'sections[2].content[1].options'), value)
      )
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[2].content[2].value.label',
        self.getLabelForSelect(self.configManager.getValue(uiconf, 'sections[2].content[2].options'), value)
      )
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[2].content[3].value.label',
        self.getLabelForSelect(self.configManager.getValue(uiconf, 'sections[2].content[3].options'), value)
      )
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[2].content[4].value.label',
        self.getLabelForSelect(self.configManager.getValue(uiconf, 'sections[2].content[4].options'), value)
      )
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[2].content[5].value.label',
        self.getLabelForSelect(self.configManager.getValue(uiconf, 'sections[2].content[5].options'), value)
      )
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[2].content[6].value.label',
        self.getLabelForSelect(self.configManager.getValue(uiconf, 'sections[2].content[6].options'), value)
      )
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[2].content[7].value.label',
        self.getLabelForSelect(self.configManager.getValue(uiconf, 'sections[2].content[7].options'), value)
      )
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[3].content[2].value.label',
        self.getLabelForSelect(self.configManager.getValue(uiconf, 'sections[3].content[2].options'), value)
      )
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[3].content[3].value.label',
        self.getLabelForSelect(self.configManager.getValue(uiconf, 'sections[3].content[3].options'), value)
      )
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[3].content[4].value.label',
        self.getLabelForSelect(self.configManager.getValue(uiconf, 'sections[3].content[4].options'), value)
      )
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[3].content[5].value.label',
        self.getLabelForSelect(self.configManager.getValue(uiconf, 'sections[3].content[5].options'), value)
      )
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[3].content[6].value.label',
        self.getLabelForSelect(self.configManager.getValue(uiconf, 'sections[3].content[6].options'), value)
      )
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[4].content[0].value.label',
        self.getLabelForSelect(self.configManager.getValue(uiconf, 'sections[4].content[0].options'), value)
      )
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[4].content[1].value.label',
        self.getLabelForSelect(self.configManager.getValue(uiconf, 'sections[4].content[1].options'), value)
      )
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[4].content[2].value.label',
        self.getLabelForSelect(self.configManager.getValue(uiconf, 'sections[4].content[2].options'), value)
      )
      ...
      self.configManager.setUIConfigParam(
        uiconf,
        'sections[4].content[3].value.label',
        self.getLabelForSelect(self.configManager.getValue(uiconf, 'sections[4].content[3].options'), value)
      )
      ...
      if (dspoptions && dspoptions.length > 0) {
        self.configManager.setUIConfigParam(
          uiconf,
          'sections[1].label',
          outdevicename + ' ' + self.commandRouter.getI18nString('PLAYBACK_OPTIONS.ADVANCED_DAC_DSP_OPTIONS')
        )
        ...
        for (var w = 0; w < dspoptions.length; w++) {
          ...
          var dspconf = {
            id: dspoptions[w].name,
            element: 'select',
            label: dspoptions[w].name,
            hidden: false,
            value: {value: dspoptions[w].value, label: dspoptions[w].value},
            options: [],
          }
...
ControllerAlsa.prototype.saveDSPOptions = function (data) {
  ...
  if (outdevicename == 'Allo Piano 2.1') {
    var SubValue = execSync('amixer get -c ' + value + " 'Subwoofer mode' | grep Item0", {encoding: 'utf8'}).split(
      "'"
    )[1]
    var DualModeValue = execSync('amixer get -c ' + value + " 'Dual Mode' | grep Item0", {encoding: 'utf8'}).split(
      "'"
    )[1]
  ...
  for (var i in data) {
    ...
    try {
      execSync('/usr/bin/amixer -c ' + value + ' set "' + dspname + '" "' + dspvalue + '"', {
        uid: 1000,
        gid: 1000,
        encoding: 'utf8',
      })
  ...
  self.commandRouter.pushToastMessage(
    'success',
    self.commandRouter.getI18nString('PLAYBACK_OPTIONS.ADVANCED_DAC_DSP_OPTIONS'),
    self.commandRouter.getI18nString('PLAYBACK_OPTIONS.DSP_PROGRAM_ENABLED')
  )
...
ControllerAlsa.prototype.getDSPDACOptions = function (data) {
  ...
  var dspdata = fs.readJsonSync('/volumio/app/plugins/audio_interface/alsa_controller/dac_dsp.json', 'utf8', {
    throws: false,
  })
  var dspobject = {}
  var dspcontrols = []
...
ControllerAlsa.prototype.saveAlsaOptions = function (data) {
  ...
  if (data.i2s) {
    var I2SNumber = self.commandRouter.executeOnPlugin(
      'system_controller',
      'i2s_dacs',
      'getI2SNumber',
      data.i2sid.label
    ...
    if (i2sstatus.name != data.i2sid.label) {
      ...
      var response = self.commandRouter.executeOnPlugin(
        'system_controller',
        'i2s_dacs',
        'enableI2SDAC',
        data.i2sid.label
        ...
        response
          .then(function (result) {
            if (result.reboot == 'yes') {
              ...
              self.commandRouter.executeOnPlugin('miscellanea', 'wizard', 'setWizardAction', {
                action: 'reboot',
                dacName: data.i2sid.label,
              })
            }
          })
          .fail(function () {
  ...
  if (process.env.MODULAR_ALSA_PIPELINE === 'true') {
    ...
    return promise.then(self.updateALSAConfigFile.bind(self)).then((result) => {
      if (result.changed) {
        self.commandRouter.sharedVars.set('alsa.outputdevice', 'volumio')
      }
      return result
...
ControllerAlsa.prototype.saveVolumeOptions = function (data) {
  ...
  self.commandRouter.pushToastMessage(
    'success',
    self.commandRouter.getI18nString('PLAYBACK_OPTIONS.MIXER_CONTROLS'),
    self.commandRouter.getI18nString('PLAYBACK_OPTIONS.MIXER_CONTROLS_UPDATE')
  )
...
ControllerAlsa.prototype.saveResamplingOpts = function (data) {
  ...
  self.commandRouter.pushToastMessage(
    'success',
    self.commandRouter.getI18nString('PLAYBACK_OPTIONS.AUDIO_RESAMPLING'),
    self.commandRouter.getI18nString('PLAYBACK_OPTIONS.AUDIO_RESAMPLING_SETTINGS_SAVED')
  )
...
ControllerAlsa.prototype.getCardByAlsaCardNameAndDevice = function (cards, name, device) {
  ...
  var n = cards.length
  for (var i = 0; i < n; i++) {
    if (cards[i].alsacard == name && (device === null || cards[i].alsadevice == device)) {
      return cards[i]
    }
  }
...
ControllerAlsa.prototype.getAlsaCards = function () {
  ...
  try {
    var ignoredCards = fs.readJsonSync(
      '/volumio/app/plugins/audio_interface/alsa_controller/ignoreCards.json',
      'utf8',
      {throws: false}
    )
  } catch (e) {
  ...
  try {
    var extendedCardsInfo = fs.readJsonSync(
      '/volumio/app/plugins/audio_interface/alsa_controller/extendedOutputDevices.json',
      'utf8',
      {throws: false}
    )
...
ControllerAlsa.prototype.getAplayInfo = function () {
  ...
  try {
    ...
    if (
      (namesArray.includes('TinkerAudio OnBoard') || namesArray.includes('USB Audio OnBoard')) &&
      namesArray.includes('ES90x8Q2M DAC')
    ) {
      try {
        var sysVariant = execSync("cat /etc/os-release | grep ^VOLUMIO_VARIANT | tr -d 'VOLUMIO_VARIANT=\"'")
          .toString()
          .replace('\n', '')
      } catch (e) {
...
ControllerAlsa.prototype.enableSoftMixer = function (data) {
  ...
  var promise = null
  if (process.env.MODULAR_ALSA_PIPELINE === 'true') {
    promise = self.writeSoftVolContribution(data).then(self.updateALSAConfigFile.bind(self))
  } else {
...
ControllerAlsa.prototype.updateVolumeSettings = function () {
  ...
  if (
    deviceVolumeOverride &&
    deviceVolumeOverride.card !== undefined &&
    deviceVolumeOverride.pluginType &&
...
ControllerAlsa.prototype.getAudioDevices = function () {
  ...
  if (i2soptions.length > 0) {
    ...
    var response = {
      devices: {active: {name: outdevicename, id: outputdevice}, available: devicesarray},
      i2s: {enabled: i2sstatus.enabled, active: i2sdevice, available: i2sarray},
    }
...
ControllerAlsa.prototype.usbAudioAttach = function () {
  ...
  if (usbHotplug && !ignoreUsbAudioAttach && outdev === '5') {
    ...
    var usbData = {
      disallowPush: true,
      output_device: {value: '5', label: usbCard.name, alsacard: usbCard.alsacard},
      i2s: false,
    }
    self.commandRouter.pushToastMessage(
      'success',
      self.commandRouter.getI18nString('PLAYBACK_OPTIONS.USB_DAC_CONNECTED'),
      usbCard.name
    )
...
ControllerAlsa.prototype.checkAudioDeviceAvailable = function () {
  ...
  if (cards.length === 0) {
    ...
    if (!found && outdevName !== undefined) {
      var message =
        self.commandRouter.getI18nString('PLAYBACK_OPTIONS.CONNECT_OUTPUT_DEVICE_1') +
        ' ' +
        outdevName +
        ' ' +
        self.commandRouter.getI18nString('PLAYBACK_OPTIONS.CONNECT_OUTPUT_DEVICE_2')
      var responseData = {
...
ControllerAlsa.prototype.getPluginALSAContributions = function () {
    ...
    for (var j = 0; j < plugins[i].catPlugin.length; j++) {
      ...
      if (this.commandRouter.pluginManager.isEnabled(category, plugin.name)) {
        ...
        if (folder) {
          ...
          alsaSnippetChecks.push(
            self.searchFolderForPluginALSAContributions(
              plugin,
  ...
  return libQ.all(alsaSnippetChecks).then(
    (snippetData) => {
      ...
      files.forEach(function (file) {
        ...
        if (tokens.length < 2 || tokens.length > 3) {
          self.logger.warn(
            'The plugin ' +
              plugin.name +
              ' is trying to supply ALSA configuration but the file ' +
              file +
  ...
  outputDevices
    .then((devices) => {
      ...
      for (var i in devices.devices.available) {
        devicesToPopulate.push(
          self.matchCardWithExtendedOutputDevicesProperties(devices.devices.available[i], carddata)
        )
      }
...
ControllerAlsa.prototype.retrieveExtendedOutputDevicesProperties = function (card) {
  ...
  self
    .readAudioCardDeviceCapabilities(card)
    .then((capabilities) => {
...
ControllerAlsa.prototype.readAudioCardDeviceCapabilities = function (card) {
  ...
  var advancedAudioCapabilities = {
    ...
    supportedFormats: ['SUPPORTED_FORMAT_PCM'],
  }
...
ControllerAlsa.prototype.parseAudioCardDeviceMaxRates = function (data) {
  ...
  try {
    ...
    const ratesLine = lines.find((line) => line.includes('sampling rate'))
...
ControllerAlsa.prototype.checkIfSelectedCardIsAvailable = function (alsaCardName, cardNumber) {
  ...
  try {
    ...
    var isAvailableCommand = execSync('amixer -c ' + cardNumber + ' info | grep "' + alsaCardName + '"', {
      encoding: 'utf8',
    })
